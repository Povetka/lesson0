...
api = 'тут должен быть ключ, но бот папа не разрешает им делиться'
bot = Bot(token=api)
...
# (для женщин или мужчин - на ваше усмотрение). Данные для формулы берите из ранее объявленной переменной data
