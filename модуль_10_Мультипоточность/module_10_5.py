...
# Если делать вызов функции в многопроцессном и линейном режиме после этой конструкции,
...
if __name__ == '__main__':
    ...
    print(f'Линейно: {end_linear - start_linear}')
    ...
    print(f'Многопроцессно: {end_multi - start_multi}')
...
# Вызовите функцию read_info для каждого файла по очереди (линейно) и измерьте время выполнения
