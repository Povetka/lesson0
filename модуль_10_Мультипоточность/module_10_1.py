...
print(f'Время работы функций = {time_res_func}')

time_start_flow = time.time()

call_gnome_1 = Thread(target=write_words, args=(10, 'example5.txt'))
call_gnome_2 = Thread(target=write_words, args=(30, 'example6.txt'))
call_gnome_3 = Thread(target=write_words, args=(200, 'example7.txt'))
call_gnome_4 = Thread(target=write_words, args=(100, 'example8.txt'))
...
time_stop_flow = time.time()
time_res_flow = time_start_flow - time_stop_flow
print(f'Время работы потоков = {time_res_flow}')
