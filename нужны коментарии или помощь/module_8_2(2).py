# Почему-то задваивается результат
...
# норм работает только с доп функцией
print('\nдругой вариант решения\n')


def len_num(numbers):
    try:
        len_sum_list = [i for i in numbers if type(i) == int or type(i) == float]  # честно говоря, не очень понимаю
    except TypeError as exp:                                                       # как работает эта строчка,
        pass                                                                       # я нагуглила похожую задачу
    return len_sum_list                                                            # и адаптировала под свой код.
