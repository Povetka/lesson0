...
def calculate_structure_sum(a):
    ...
    for i in data_structure:
        if i == int:
            ...
            i += 1
            continue
    print(int_list) # хотела для начала собрать все числа в один список, чтобы потом их суммировать и далее собирать
    # в другой список длину, суммировать
    # затем их между собой, но вижу, что у меня не выходит и первая часть задумки.
...
# isinstance() как ее включить в решение?
